...
if [ -f civic_op.make ]; then
  echo -e "\nThis command can be used to run civic_op.make in place "
#  echo -e ", or to generate"
#  echo -e "a complete distribution of Civic.\n\nWhich would you like?"
  echo "  [1] Press 1 to rebuild Civic Open Public in place (overwrites any changes!)."
